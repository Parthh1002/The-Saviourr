        ...
        <div ref={ref} className="reveal">
          <div className="relative glass rounded-3xl p-8 md:p-10 max-w-md mx-auto">
            ...
            <div className="space-y-4">
              ...
              <button
                type="button"
                className="w-full mt-2 inline-flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-neon text-primary-foreground font-medium tracking-wide hover:scale-[1.02] transition-transform group"
              ...
              <div className="flex items-center justify-between text-[11px] font-mono uppercase tracking-widest text-muted-foreground pt-2">

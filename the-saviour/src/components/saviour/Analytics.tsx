      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 grid lg:grid-cols-5 gap-4">
          <div className="lg:col-span-3 glass rounded-2xl p-6 md:p-8">
            ...
            <div className="flex items-end gap-3 md:gap-4 h-48 px-2">
              {bars.map((b, i) => (
                <div key={b.l} className="flex-1 flex flex-col items-center gap-2 h-full justify-end">
                  <div
                    className="w-full rounded-t-md hover:scale-[1.05] transition-all duration-300 shadow-[0_4px_12px_rgba(5,150,105,0.2)] cursor-pointer"
                    style={{
                      height: `${b.v}%`,
                      background: "linear-gradient(to top, #059669, #34d399)",
                      animation: `fade-in 1s cubic-bezier(0.19, 1, 0.22, 1) ${i * 100}ms forwards`,
                    }}
                  />
              ...
              {species.map((s) => (
                <div key={s.n}>
                  ...
                  <div className="h-2.5 rounded-full bg-slate-100 overflow-hidden border border-slate-200/50">
                    <div
                      className="h-full bg-gradient-to-r from-emerald-600 to-emerald-400 rounded-full shadow-[0_0_8px_rgba(5,150,105,0.25)] transition-all duration-[1.5s]"
                      style={{ width: `${s.p * 3.2}%`, maxWidth: "100%" }}
                    />
                  </div>
                </div>
              ))}

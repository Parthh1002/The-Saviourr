...
export function Story() {
  ...
  return (
    <section id="story" className="relative py-12 md:py-20 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-6 flex items-center gap-4 text-lg md:text-xl font-mono uppercase tracking-[0.3em] text-neon/70 reveal" ref={ref}>
          <span className="w-12 h-px bg-neon/40" />
          Chapter 01 — The Problem
        </div>

        <div className="space-y-2 md:space-y-4 font-display text-2xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.15] tracking-tight">
          {lines.map((l, i) => (
        ...
        <div className="mt-12 sm:mt-16 grid md:grid-cols-3 gap-6 text-sm text-muted-foreground">
          <RevealBlock delay={0}>

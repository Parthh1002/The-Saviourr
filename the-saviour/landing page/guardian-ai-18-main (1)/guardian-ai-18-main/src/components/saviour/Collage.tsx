import natureWatching from "@/assets/nature-watching.png";
  ...
  return (
    <section className="relative py-20 md:py-28 px-6 overflow-hidden">
      ...
      <div ref={ref} className="reveal mx-auto max-w-7xl">
        ...
        <div className="relative rounded-3xl overflow-hidden border border-border bg-card shadow-[0_30px_80px_-30px_oklch(0.4_0.05_160_/_0.25)]">
          <img
            src={natureWatching}
